...
def after_proccess(request):
    ...
    rgb_image = Read_Image(Orig_image) 

    rgb_original_image = Read_Image(Orig_image)     

    # Converting to gray
    # print("Converting to grayd")
    eq_hist, gray_image = Gray_Scale_and_Equalize(rgb_original_image)
    ...
    # print("Drawing image of number of infected region")
    ...
    try:
        ...
        Save_Images(img_path, rgb_original_image, rgb_image, gray_image, eq_hist, binary_image, Morph_image, spot_on_org_img, black_img)
...
def uploaded(request):
    ...
    try:
        ...
        errorfound_or_not = True
        print("OpenCV Error:", cv_error)
        error = f"OpenCV Error: {cv_error}"
        ...
        if str(e) == 'original_image':
            ...
            error = "An error occurred while processing the image with OpenCV.", e
